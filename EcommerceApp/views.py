...
def readDetails(contract_type):
    ...
    deployed_contract_address = '0x97D99040D50b5247DB299CFcdc8b56387844f551' #hash address to access student contract
...
def saveDataBlockChain(currentData, contract_type):
    ...
    deployed_contract_address = '0x97D99040D50b5247DB299CFcdc8b56387844f551' #contract address
    with open(compiled_contract_path) as file:
        contract_json = json.load(file)  # load contract info as JSON
        contract_abi = contract_json['abi']  # fetch contract's abi - necessary to call its functions
    file.close()
        ...
        for i in range(len(rows)-1):
            ...
            if arr[0] == 'addproduct':
                if arr[2] == ptype:
                    ...
                    if os.path.exists('C:/Users/RAVI/Desktop/BlockchainEcommerce/BlockchainEcommerce/EcommerceApp/static/product.png'):
                        os.remove('C:/Users/RAVI/Desktop/BlockchainEcommerce/BlockchainEcommerce/EcommerceApp/static/product.png')
                    with open('C:/Users/RAVI/Desktop/BlockchainEcommerce/BlockchainEcommerce/EcommerceApp/static/product.png', "wb") as file:
                        file.write(content)
                    file.close()
